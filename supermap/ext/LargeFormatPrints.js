(function(){
     ...
     * pageSize:"A0", only support A1 and A0
     * */
     LargeFormatPrint.excute = function(url,projection,scale,center,pageSize,map,callback){
         if(url&&projection&&scale&&center&&pageSize){
             //Request a whole piece of picture for the server side
         ...
         function onImgLoad(){
             //Put the image to the page to view the effect. You can click the cancel button.
            ...
            // img.style.width = "935px";
             ...
             button.onclick = function(){
                 //Put the image to the page, and call the browser to print the interface
