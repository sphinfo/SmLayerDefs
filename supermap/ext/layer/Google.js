...
SuperMap.Layer.Google = SuperMap.Class(
    ...
    SuperMap.Layer.FixedZoomLevels, {
         ...
         * {Integer} Minimum zoom level,0
         */
        MIN_ZOOM_LEVEL: 0,

        /**
         * Constant: MAX_ZOOM_LEVEL
         * {Integer} Maxmum zoom level,21。
         */
        MAX_ZOOM_LEVEL: 21,
         ...
         * Resolution array is fixed value, it will be more close to the standard WMS projection。
         */
        RESOLUTIONS: [
            1.40625,
            0.703125,
        ...
        /**
         * APIProperty: type
         * {GMapType} Specifies the layer type that needs to be acquired, the default value is unll, and the layer is "G_STREETS_MAP" ".
         * Layer types provided by the Google service are:PHYSICAL、HYBRID、SATELLITE、STREETS。
         */
        type: null,

        /**
         * APIProperty: wrapDateLine
         * {Boolean} Horizontal direction adjustment is allowed.Default is true
         * When <sphericalMercator> is true,Setting this item for the false can limit the horizontal direction adjustment.
         */
        wrapDateLine: true,

        /**
         * APIProperty: sphericalMercator
         * {Boolean} Whether to use Mercator projection, the default value is false.
         * If you use the Mercator projection, will lead to all interaction with the map is actually the interaction with map projection, it supports vector drawing, map overlay and so on.
         */
         ...
         * Google layer constructor function
         *
         *  Example：
         * (code)
         *
         ...
         * options - {Object}  an options object,the properties on this object will be set to the layer.
         */
         ...
         * Set the visibility marker. Trigger events unless otherwise specified
         *
         * Note that this visibility is no longer simply a layer of style. Display is set to "block"". Now we store a 'visibility' state property on the layer class，
         * This allows us to record whether a layer is required to have visibility properties. When the map's resolution is outside of the scope of the layer, this attribute may be overturned.
         *
         * Parameters:
         * visible - {Boolean} Display layer (Within the scope)
         */
         ...
         * zoomChanged - {Boolean} Indicates when the zoom is starting to change, and when the layer has to do some initial work.
         * dragging - {Boolean}
         */
