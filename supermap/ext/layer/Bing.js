...
SuperMap.Layer.Bing = SuperMap.Class(SuperMap.CanvasLayer, {
     ...
     * (end)
     *
     * The default for the Mercator projection, so when you elements and map location on the map you need to coordinate conversion
     * Example:
     * (code)
     *
     ...
     * type - {String} Layer identifier. Any non-birdseye imageryType
     *     from http://msdn.microsoft.com/en-us/library/ff701716.aspx can be
     *     used.
    ...
    /**
     * APIMethod: destroy
     * Deconstruct the TiledCachedLayer class, the release of resources.
     */
    destroy: function () {
        var me = this;
