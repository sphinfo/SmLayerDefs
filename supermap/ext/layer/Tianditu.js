 ...
 * Tianditu service layer class.
 *     Used to display tianditu map service, use the <SuperMap.Layer.Tianditu>
 *     constructor function to create the tianditu layer, more information to view:
 *
 * Inherits from:
...
SuperMap.Layer.Tianditu = SuperMap.Class(SuperMap.CanvasLayer, {
     ...
     * {String} Layer type.(vec:Vector layer,img:Image layer,ter:Terrain)
     */
    layerType:"vec",    //(vec:Vector layer,cva:Vector label layer,img:Image layer,cia:Image lable layer,ter:Terrain,cta:Terrain lable layer)

    /**
     * APIProperty: isLabel
     * {Boolean} Is a label layer.
     */
    isLabel:false,
    ...
    /**
     * Property: zOffset
     * {Number} Z value offset in picture URL
     */
    zOffset:1,
    /**
     * Constructor: SuperMap.Layer.Tianditu
     * Create tianditu layer
     *
     * Example:
     * (code)
...
//        }, options);
     ...
     *
     * Returns:
     * {<SuperMap.Layer.Tianditu>}  new layer
     */
    clone: function (obj) {
        var me = this;
        if (obj == null) {
     ...
     * Set the map related parameters
     *
     * Parameters:
     * projection - {String} Projection coordinate system
     */
