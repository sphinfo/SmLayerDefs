 ...
 * Baidu service layer class.
 *     Used to display Baidu map，using <SuperMap.Layer.Baidu>
 *     constructor can create the Baidu layer, more information to view:
 *
 *
 *
 * Inherits from:
...
*/
       ...
       // console.log(Math.pow(2, 15) * 256 * 4);    // bounds 3 16  2 4  1 1     19-3=16     0.5  15
        ...
        var resAry= [];
        for (var i = 0; i < 17; i++)    //Baidu 3-19
        {
            resAry[i] = res;
            res *= 0.5;                 //Each time 1/2
        }

        //Computing scale array
        var scaAry = [];
        for(var i = 0;i<17;i++)
        {
            scaAry[i] = 0.0254/(96*resAry[i]);   //0.0254 conversion constant inch and meter  //PPI pixels per inch
        }
        ...
        me.units = "m";
		//Projection changed from non official 900913 to 3857
        me.projection = "EPSG:3857";
    },

    /**
     * APIMethod: clone
     * Create copy of the current layer
     *
     * Parameters:
     * obj - {Object}
     *
     * Returns:
     * {<SuperMap.Layer.Baidu>}  new layer
     */
    clone: function (obj) {
        var me = this;
        if (obj == null) {
