 ...
 * Pie graph
 *
 * Pie configuration object chartsSetting（<SuperMap.Layer.Graph::chartsSetting>） properties setting are as follows：
 *
 ...
 *
 * sectorStyle - {Object} Based style of sector in a pie graph.This parameter controls the column base style, the priority is lower than the sectorStyleByFields and sectorStyleByCodomain。
 ...
 * sectorStyleByCodomain - {Array{Object}} Value range of the pie control the style, a higher priority than sectorStyle and sectorStyleByFields
 * (start code)
...
SuperMap.Feature.Theme.Pie = SuperMap.Class(SuperMap.Feature.Theme.Graph, {
     ...
     *
     * Returns:
     * {<SuperMap.Feature.Theme.Pie>}  Return a bar graph object
     */
    ...
    assembleShapes: function(){
        ...
        // Important steps: the definition of unit chart Pie data view box value meaning, unit value: value of each representative of
