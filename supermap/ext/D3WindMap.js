(function () {
    function A(option) {
        ...
        t._svg = null;
        t._tempData=null;
        t._stepPointCount = 4;//Points about each step
        t._stepPointCountOffset = 5;//Point range about each step
        t._minStepLength = 5;//Length of each segment
        t._maxStepLength = 15;
        t._stepStatus = {};
        t._stepPointMargin =3;
        t._stepNum =3;//The number of small segments
        t._stepOffset = 30; //Offset of point
        t._maxSpeed = 500;
        t._minSpeed = 200;
