/* Copyright (c) 2006-2015 by SuperMap Contributors (see authors.txt for
 ...
 * <SuperMap.Control.UTFGrid> control as well.
 *
 * Example:
 *
 * (start code)
 * var world_utfgrid = new SuperMap.Layer.UTFGrid({
 ...
 *  - <SuperMap.Layer.XYZ>
 */
SuperMap.Layer.UTFGridOL = SuperMap.Class(SuperMap.Layer.XYZ, {
     ...
     *     <SuperMap.Tile.UTFGrid>).
     */

    /**
     * Property: tileClass
     * {<SuperMap.Tile>} The tile class to use for this layer.
     *     Defaults is <SuperMap.Tile.UTFGrid>.
     */
     ...
     * 
     * Returns:
     * {<SuperMap.Layer.UTFGrid>} An exact clone of this SuperMap.Layer.UTFGrid
     */
    clone: function (obj) {
        if (obj == null) {
     ...
     *
     * Parameters:
     * location - {<SuperMap.LonLat>} map location
     *
     * Returns:
    ...
    CLASS_NAME: "SuperMap.Layer.UTFGridOL"
});