...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        return this.each(function(){
            ...
            obj.bind(opts.event,function(){
                //Location
                var ttop  = $(this).offset().top;     //Height of control location
                var thei  = $(this).height();  //Height of control
                var tleft = $(this).offset().left-238;    //Width of control location
                $("#colorpanel").css({
                    top:ttop+thei+5,
                    left:tleft
                }).show();
        ...
        function initColor(){
            ...
            +'<td width="3"><td><input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;margin-top: 13px;width: 59px;height: 17px" value="#000000"><a href="javascript:void(0);" id="_cclose" style="margin-left: -11px">Close</a> | <a href="javascript:void(0);" id="_creset">Clear</a></td></tr></table></td></table>'
    ...
    jQuery.fn.colorpicker.defaults = {
        ishex : true, //Whether to use the 16 band color value
        fillcolor:false,  //Whether the color value is filled to the object's val
        target: null, //Target object
        event: 'click', //Event that displaying in the color box
